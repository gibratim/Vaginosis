...
namespace VaginosisApp
{
    public partial class TestingPage : PhoneApplicationPage
    {
        ...
        private async Task<string> GetMessage()
        {
            ...
            System.Diagnostics.Debug.WriteLine(_dataReader);
        ...
        private void UpdateChatBox(string message, bool isIncoming)
        {
            ...
            this.Dispatcher.BeginInvoke(() =>
            {
                ...
                tbChat.Text = (isIncoming) ? tbChat.Text : string.Empty;
            });
        }
        ...
        {
            _peerName = DeviceName.Text;
            PeerFinder.ConnectionRequested += PeerFinder_ConnectionRequested;
            ListenForIncomingMessage();
        }

        private void FindPeers_Click(object sender, RoutedEventArgs e)
        {
